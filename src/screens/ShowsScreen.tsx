...
// Íconos
import { FontAwesome } from "@expo/vector-icons"; // carrito
import { MaterialIcons } from "@expo/vector-icons"; // ubicación
...
const ShowsScreen = () => {
    ...
    const fetchShows = async () => {
        try {
            ...
            const showsData: Show[] = snapshot.docs.map((doc) => ({
                id: doc.id,
                ...doc.data(),
            })) as Show[];
            setShows(showsData);
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.textNextShows}>
                Next Shows
            </Text>
            <FlatList
                data={shows}
                        ...
                        <TouchableWithoutFeedback>
                            <View style={styles.modalContent}>
                                {selectedShow && (
                                    <>
                                        <Image
                                            source={{ uri: selectedShow.imageUrl }}
